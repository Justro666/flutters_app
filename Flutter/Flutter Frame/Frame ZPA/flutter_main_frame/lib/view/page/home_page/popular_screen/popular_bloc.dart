...
import 'package:flutter_main_frame/network/base_network.dart';
...
class PopularBloc extends BaseNetwork {
  ...
  Stream<ResponseOb> popularStream() {
  ...
  getPopularMovie() {
    ...
    getRequest(
            endUrl:
                "popular?api_key=f45b7e038139d8e9bb9f8878d46b6030&language=en-US&page=1")
        .then((resp) {
